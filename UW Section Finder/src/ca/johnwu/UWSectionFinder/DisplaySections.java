				...
				try {
				 ...
				 System.out.println("HI FRED");
					for (int i =0 ; i<(a.size()); i++){
						...
						if (i%2 ==1){
							if (a.get(i).lastIndexOf(" ") > a.get(i).lastIndexOf(",")){
								a.set(i, (a.get(i).substring( 0,a.get(i).lastIndexOf(" ")) )); 
							}
							String prof = (a.get(i)).substring((1+ a.get(i).lastIndexOf(" ")));
							prof = prof.substring(0, prof.indexOf(",")) + ", " + prof.substring((prof.indexOf(",")+1));
